...
\#Projekt \#\# Zagadnienie \textbf{\emph{Temat:}} \emph{Lokalna regresja
(predykcja wartości funkcji docelowej dla przykładu za pomocą modelu
jednorazowego użytku budowanego na podstawie jego „najbliższych
sąsiadów''). Eksperymenty z kilkoma różnymialgorytmami do budowania
modeli lokalnych. Porównanie z algorytmami regresji dostępnymi w R.}
...
in the editor is displayed.asdasdasdasdasdasdasdasdasdsa
