...
ns <- seq(1, 401, by=100)
errs <- sapply(ns, function(x) { print(x); markClassifier(rs_model, data$test, regressionTreeWrap, x, house.price.of.unit.area ~ .)$testError}) # change the `mse` at the end to the value that you are interested in
print(errs)
plot(ns, errs$mse, xlab="#neighbours", ylab="mse", type="l")
plot(ns, errs$mre, xlab="#neighbours", ylab="mse", type="l")
plot(ns, errs$cod_old, xlab="#neighbours", ylab="mse", type="l")
plot(ns, errs$cod, xlab="#neighbours", ylab="mse", type="l")
```
